    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative bg-white w-full max-w-md rounded-xl shadow-xl overflow-hidden z-10">
            ...
            <div class="px-6 py-4 bg-gray-50 flex justify-center gap-3 border-t border-gray-100">
                <button class="flex-1 px-6 py-2.5 rounded-md text-sm font-bold text-gray-600 hover:bg-gray-100 transition-colors border border-gray-300 font-label-md" onclick="document.getElementById('{{ $id }}').classList.add('hidden')" type="button">Batal</button>
