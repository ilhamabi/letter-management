...
<x-modal :id="$id" title="Ubah Alur Persetujuan" maxWidth="max-w-md" zIndex="z-[100]" x-data="{ 
    selectedFlow: 1, 
    filterOpen: false, 
    ...
    <x-slot:footer>
        <button class="px-6 py-2 rounded-md text-sm font-bold text-gray-600 hover:bg-gray-100 transition-colors border border-gray-300 font-label-md" onclick="closeModal('{{ $id }}')" type="button">
            Batal
        </button>
