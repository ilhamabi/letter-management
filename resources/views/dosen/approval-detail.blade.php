...
<body class="flex h-screen overflow-hidden text-sm relative">
    ...
    <aside
        class="w-64 flex-shrink-0 bg-white border-r border-gray-200 flex flex-col justify-between h-full overflow-y-auto"
            ...
            <div class="mb-4">
                <nav class="flex items-center gap-2 text-gray-400 mb-3">
                    <a class="font-body-sm text-body-sm hover:text-primary transition-colors"
                        href="{{ url('/lecturer/approval') }}">Persetujuan Dokumen</a>
                    <span class="material-symbols-outlined text-[16px]">chevron_right</span>
                    <span class="font-label-sm text-label-sm text-gray-900 uppercase tracking-wider">Detail
                        Permintaan</span>
                </nav>
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div
                        class="inline-flex items-center gap-2 px-4 py-2 bg-[#FEF3C7] border border-[#FDE68A] rounded-full self-start">
                ...
                <div class="xl:col-span-8 flex flex-col gap-6">
                    <div class="bg-white border border-gray-200 rounded-xl flex flex-col shadow-sm">
                        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="font-label-lg text-label-lg text-gray-900">
                                        Surat_Keterangan_Aktif_Draft.pdf</h3>
                            ...
                            <div class="flex gap-2">
                                ...
                                <button
                                    ...
                                    <span class="font-label-sm text-label-sm hidden sm:inline font-semibold">Unduh
                                        File</span>
                                </button>
                            </div>
                        </div>
                        <div class="flex-1 bg-gray-50 p-8 flex justify-center overflow-x-auto">
                            <div
                                class="w-full max-w-[600px] bg-white shadow-[0_4px_12px_rgba(0,0,0,0.08)] border border-gray-200 min-h-[800px] p-12 shrink-0">
                                <div class="border-b-2 border-[#410063] pb-6 mb-8 text-center">
                                    <h4
                                        class="font-title-lg text-title-lg font-bold text-primary uppercase tracking-widest">
                                        Universitas Amikom</h4>
                                    <p class="font-body-sm text-body-sm text-gray-400 mt-1">Fakultas Ilmu Komputer</p>
                                </div>
                                <h5 class="font-label-lg text-label-lg text-center mb-8 underline">SURAT KETERANGAN
                                    AKTIF KULIAH</h5>
                                <div class="space-y-4 font-body-sm text-body-sm text-gray-900">
                                    <p class="">Yang bertanda tangan di bawah ini, Dekan Fakultas Ilmu Komputer
                                        menerangkan bahwa:</p>
                                    <div class="grid grid-cols-[150px_1fr] gap-2 pl-4">
                                        <div class="font-semibold">Nama</div>
                                        <div class="">: Budi Santoso</div>
                                        <div class="font-semibold">NIM</div>
                                        <div class="">: 19.11.1234</div>
                                        <div class="font-semibold">Program Studi</div>
                                        <div class="">: S1 Informatika</div>
                                        <div class="font-semibold">Semester</div>
                                        <div class="">: V (Lima)</div>
                                    </div>
                                    <p class="pt-4">Adalah benar mahasiswa yang bersangkutan aktif mengikuti
                                        perkuliahan pada semester Ganjil Tahun Akademik 2023/2024.</p>
                                    <p class="">Surat keterangan ini dibuat untuk keperluan: <strong>Pengajuan
                                            Beasiswa Prestasi</strong>.</p>
                ...
                <div class="xl:col-span-4 flex flex-col gap-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                        ...
                        <div class="flex items-center gap-4 mb-8">
                            <div class="relative">
                                <img alt="Student Photo"
                                    class="w-20 h-20 rounded-xl object-cover border-2 border-primary/10 shadow-sm"
                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCWpkD_4yvUyMSwxHNUJuzKAKtY12jPb_MLsTooCargeRYX6NaQBI2bff_U-c21QrYBvM1FYwxvAITMWnMUrppNQC6Ua_LSuH1uNB6we5T5ONUMone2gSEHrfN5r0Id5XFDPvf2MdJfnu_6r8c-ucwsIZVzl86oO5BBn8tgU_f4RZhrumAQD37GnuaZN8UVyo_60E7fGmV9No8H1uJhOCEGCSnJCIhzRmBKcgySgGlFdDFMNKs6zj8ybc3fcDlxL2mtBsJwBLFQBNo">
                                <div
                                    class="absolute -bottom-1 -right-1 w-6 h-6 bg-secondary rounded-full border-2 border-white flex items-center justify-center">
                        ...
                        <div class="space-y-3">
                            <div
                                ...
                                <span
                                    class="font-body-sm text-body-sm text-primary bg-primary/10 px-3 py-1 rounded-full font-bold">S1
                                    Informatika</span>
                            </div>
                            <div
                                class="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
                                        <span
                                            class="material-symbols-outlined text-primary text-[20px]">trending_up</span>
                                    </div>
                                    <span
                                        class="font-label-sm text-label-sm text-gray-500 uppercase tracking-wider font-semibold">Status</span>
                                </div>
                                <span
                                    class="font-body-sm text-body-sm text-[#584409] bg-[#ffe16d] px-3 py-1 rounded-full font-bold">Aktif
                                    (Sem. 5)</span>
                            </div>
                        ...
                        <div class="">
                            <div class="flex items-center justify-between border-b border-gray-100 last:border-0 py-3">
                                <div class="flex flex-col gap-1.5">
                                    <span
                                        class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-amikom-purple self-start">Kaprodi</span>
                            ...
                            <div class="flex items-center justify-between border-b border-gray-100 last:border-0 py-3">
                                <div class="flex flex-col gap-1.5">
                                    <span
                                        class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-amikom-gold self-start">Dosen
                                        Wali</span>
                                    <span class="text-body-md font-semibold text-gray-900">Heri Setyawan, M.Kom.</span>
                                </div>
                            </div>
                            <div class="flex items-center justify-between border-b border-gray-100 last:border-0 py-3">
                                <div class="flex flex-col gap-1.5">
                                    <span
                                        class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-amikom-green self-start">Dosen
                                        Pembimbing</span>
                                    <span class="text-body-md font-semibold text-gray-900">Heri Setyawan, M.Kom.</span>
                                </div>
                            </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-6">
                        <div class="pb-4 border-b border-gray-100">
                            <h3 class="font-title-lg text-title-lg text-gray-900 mb-4 flex items-center gap-2"><span
                                    class="material-symbols-outlined text-primary">info</span>Detail Pengajuan</h3>
                            <div class="space-y-1">
                                <p class="text-label-sm text-gray-500 uppercase tracking-wider font-semibold">Tujuan
                                    Dokumen</p>
                                <p class="text-body-md font-medium text-gray-900">Pengajuan Beasiswa Prestasi
                                    Kemendikbud 2023</p>
                            </div>
                        </div>
                        <div>
                            <h3 class="font-title-lg text-title-lg text-gray-900 mb-6 flex items-center gap-2"><span
                                    class="material-symbols-outlined text-primary">history</span>Riwayat Status</h3>
                            <div class="space-y-0">
                                <div class="relative pl-8 pb-8 border-l-2 border-amikom-purple">
                                    <div
                                        class="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-amikom-purple border-4 border-white shadow-sm">
                                    </div>
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            class="mt-2 inline-flex self-start px-2 py-0.5 bg-green-50 text-green-800 text-[10px] font-bold uppercase rounded border border-green-100">Selesai</span>
                                    </div>
                                </div>
                                <div class="relative pl-8 pb-8 border-l-2 border-gray-200">
                                    <div
                                        class="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-amikom-gold border-4 border-white shadow-sm">
                                    </div>
                                    <div class="flex flex-col">
                                        <span class="text-label-lg text-gray-900 font-bold">Persetujuan Dosen
                                            Wali</span>
                                        <span class="text-body-sm text-gray-500">Sedang diverifikasi...</span>
                                        <span
                                            class="mt-2 inline-flex self-start px-2 py-0.5 bg-blue-50 text-blue-700 text-[10px] font-bold uppercase rounded border border-blue-100">Proses</span>
                                    </div>
                                </div>
                                <div class="relative pl-8">
                                    <div
                                        class="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-gray-200 border-4 border-white shadow-sm">
                                    </div>
                                    <div class="flex flex-col">
                                        <span class="text-label-lg text-gray-400 font-bold">Verifikasi Program
                                            Studi</span>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                        ...
                        <div class="flex gap-3 pt-2">
                            <button
                                class="flex-1 py-3 px-4 border border-error text-error font-bold rounded-xl hover:bg-error/5 transition-colors flex items-center justify-center gap-2"
                                onclick="toggleModal('reject-modal', true)">
                                <span class="material-symbols-outlined">close</span>
                                Tolak
                            </button>
                            <button
                                class="flex-[2] py-3 px-4 bg-primary text-white font-bold rounded-xl hover:bg-primary-container shadow-sm transition-colors flex items-center justify-center gap-2"
                                onclick="toggleModal('approve-modal', true)">
    ...
    <!-- Success Toast -->
    <div class="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] opacity-0 pointer-events-none transform translate-y-4"
        id="success-toast">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm hidden"
        id="reject-modal">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 border border-gray-200 font-title-lg">
            <div class="flex items-center gap-2 mb-4 p-3 bg-blue-50 border border-blue-100 rounded-lg">
                ...
                <p class="text-xs text-blue-700 font-medium">Peran yang tidak dicentang akan tetap berada pada status
                    saat ini.</p>
            </div>
            ...
            <div class="space-y-4 mb-8">
                <!-- Kaprodi Role -->
                <div class="role-group border rounded-xl overflow-hidden transition-all border-gray-200"
                    id="group-kaprodi">
                    <label class="flex items-center gap-3 p-4 bg-gray-50 cursor-pointer">
                        <input checked
                            class="role-checkbox w-5 h-5 rounded border-gray-300 text-error focus:ring-error"
                            onchange="handleRoleToggle('kaprodi')" type="checkbox">
                        <div class="flex flex-col">
                            <span
                                class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-primary self-start mb-1">KAPRODI</span>
                        </div>
                    </label>
                    <div class="reason-fields p-4 bg-white border-t border-gray-100 space-y-3 hidden"
                        id="fields-kaprodi">
                        <div>
                            <label
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Alasan
                                Penolakan</label>
                            <select
                                class="w-full bg-gray-50 border border-gray-200 rounded-lg p-2 text-sm focus:ring-1 focus:ring-primary outline-none">
                        ...
                        <textarea
                            class="w-full bg-gray-50 border border-gray-200 rounded-lg p-2 text-sm resize-none focus:ring-1 focus:ring-primary outline-none"
                            placeholder="Catatan Tambahan..." rows="2"></textarea>
                    </div>
                </div>

                <!-- Dosen Wali Role -->
                <div class="role-group border border-gray-200 rounded-xl overflow-hidden transition-all"
                    id="group-wali">
                    <label class="flex items-center gap-3 p-4 bg-gray-50 cursor-pointer">
                        <input class="role-checkbox w-5 h-5 rounded border-gray-300 text-error focus:ring-error"
                            onchange="handleRoleToggle('wali')" type="checkbox">
                        <div class="flex flex-col">
                            <span
                                class="text-[10px] font-bold text-[#6e5c00] uppercase tracking-widest px-3 py-1 rounded-full bg-[#fcd400] self-start mb-1">DOSEN
                                WALI</span>
                        </div>
                    </label>
                    <div class="reason-fields p-4 bg-white border-t border-gray-100 space-y-3 hidden"
                ...
                <div class="role-group border border-gray-200 rounded-xl overflow-hidden transition-all"
                    ...
                    <label class="flex items-center gap-3 p-4 bg-gray-50 cursor-pointer">
                        <input class="role-checkbox w-5 h-5 rounded border-gray-300 text-error focus:ring-error"
                            onchange="handleRoleToggle('pembimbing')" type="checkbox">
                        <div class="flex flex-col">
                            <span
                                class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-amikom-green self-start mb-1">PEMBIMBING</span>
                        </div>
                    </label>
                    <div class="reason-fields p-4 bg-white border-t border-gray-100 space-y-3 hidden"
                        id="fields-pembimbing">
                        <div>
                            <label
                                class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Alasan
                                Penolakan</label>
            ...
            <div class="flex gap-3 justify-end">
                <button
                    class="py-2.5 px-6 text-gray-700 hover:bg-gray-100 rounded-lg font-bold transition-colors border border-gray-300"
                    onclick="toggleModal('reject-modal', false)">Batal</button>
                <button
                    class="py-2.5 px-6 bg-error text-white rounded-lg font-bold hover:bg-error/90 transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    id="confirm-reject-btn" onclick="confirmRejection()">Konfirmasi Penolakan</button>
            </div>
        </div>
    </div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm hidden"
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 border border-gray-200 font-title-lg">
            ...
            <div class="space-y-2 mb-8">
                <label
                    class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors justify-start gap-3">
                    <input
                        class="approve-role-checkbox w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary"
                        onchange="updateApproveButtonState()" type="checkbox">
                    <span
                        class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-primary">KAPRODI</span>
                </label>
                <label
                    class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors justify-start gap-3">
                    <input
                        ...
                        onchange="updateApproveButtonState()" type="checkbox">
                    <span
                        class="text-[10px] font-bold text-[#6e5c00] uppercase tracking-widest px-3 py-1 rounded-full bg-[#fcd400]">DOSEN
                        WALI</span>
                </label>
                <label
                    class="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors justify-start gap-3">
                    <input
                        ...
                        onchange="updateApproveButtonState()" type="checkbox">
                    <span
                        class="text-[10px] font-bold text-white uppercase tracking-widest px-3 py-1 rounded-full bg-amikom-green">PEMBIMBING</span>
                </label>
            </div>

            <div class="flex gap-3 justify-end">
                <button
                    class="py-2.5 px-6 text-gray-500 hover:bg-gray-100 rounded-lg font-bold transition-colors border border-gray-300"
                    onclick="toggleModal('approve-modal', false)">Batal</button>
                <button
                    class="py-2.5 px-6 bg-primary text-white rounded-lg font-bold hover:bg-primary-container shadow-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    id="confirm-approve-btn" onclick="confirmApproval()">Setujui</button>
            </div>
        </div>
    </div>
