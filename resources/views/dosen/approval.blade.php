    ...
    <main class="flex-1 flex flex-col overflow-hidden bg-background" data-purpose="main-content">
        ...
        <div class="flex-1 overflow-y-auto p-8">
            <div class="mb-6">
                ...
                <p class="text-gray-600">Kelola dan verifikasi dokumen pengajuan mahasiswa yang membutuhkan tindakan
                    segera.</p>
            </div>
                        ...
                        <thead class="bg-[#F8F9FA] sticky top-0 z-10 text-base">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-1/5"
                                    scope="col">Peran</th>
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-24"
                                    scope="col">Status</th>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    <td class="py-20 text-center" colspan="6">
                                        <div class="flex flex-col items-center justify-center space-y-4">
                                            ...
                                            <h3 class="text-xl font-bold text-gray-900">Tidak Ada Permintaan Menunggu
                                            </h3>
                                            <p class="text-gray-500 max-w-md mx-auto">Semua dokumen telah diproses.
                                                Anda dapat memeriksa riwayat untuk melihat dokumen yang sudah selesai.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
