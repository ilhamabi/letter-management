                ...
                <div class="overflow-x-auto max-h-[500px] overflow-y-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-[#F8F9FA] sticky top-0 z-10 text-base">
                            <tr>
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-1/4"
                                    scope="col">Nama Mahasiswa</th>
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-32"
                                    scope="col">NIM</th>
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-1/4"
                                    scope="col">Jenis Surat</th>
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-40"
                                    scope="col">Tanggal Pengajuan</th>
                                <th class="px-6 py-4 text-left text-gray-600 tracking-wider uppercase w-1/5"
                                    scope="col">Peran</th>
                                <th class="px-6 py-4 text-center text-gray-600 tracking-wider uppercase w-24"
                                    scope="col">Status</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="hover:bg-gray-50 cursor-pointer transition-colors group submission-row"
                                    ...
                                    <td class="px-6 whitespace-nowrap py-4">
                                        <div class="flex flex-col gap-1.5">
                                            @foreach ($sub['roles'] as $r)
                                                <span
                                                    class="inline-flex items-center w-fit px-2.5 py-0.5 rounded-full font-semibold {{ $r['bg'] }} text-white text-[10px] uppercase">{{ $r['name'] }}</span>
                                            @endforeach
                                        </div>
                                    </td>
                                    <td class="px-6 whitespace-nowrap py-4 text-center">
                                        @if (strtoupper($sub['status']) === 'DISETUJUI')
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full font-bold bg-[#DCFCE7] text-[#166534] border border-[#166534]/10 text-[10px] tracking-wider uppercase">DISETUJUI</span>
                                        @elseif (strtoupper($sub['status']) === 'DITOLAK')
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full font-bold bg-[#FEE2E2] text-[#991B1B] border border-[#991B1B]/10 text-[10px] tracking-wider uppercase">DITOLAK</span>
                                        @else
                                            <span
                                                class="inline-flex items-center px-3 py-1 rounded-full font-bold bg-gray-100 text-gray-800 border border-gray-200 text-[10px] tracking-wider uppercase">{{ $sub['status'] }}</span>
                                        @endif
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td class="py-20 text-center" colspan="6">
                                        <div class="flex flex-col items-center justify-center gap-4">
                                            ...
                                            <div>
                                                <p class="text-lg font-semibold text-gray-900">Belum ada riwayat
                                                    persetujuan</p>
                                                <p class="text-gray-500">Semua dokumen yang telah Anda proses akan
                                                    muncul di sini.</p>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div>
                        Menampilkan <span id="startCount" class="font-medium text-gray-900">
                            ...
                            @else
                                0
                            @endif
                        </span> - <span id="endCount"
                            class="font-medium text-gray-900">{{ count($submissions) }}</span> dari <span
                            id="totalCount" class="font-medium text-gray-900">{{ count($submissions) }}</span> entri
                    </div>
