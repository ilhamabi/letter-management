                    ...
                    <div class="flex-1 bg-gray-50 p-8 flex justify-center overflow-x-auto">
                        <div
                            ...
                            <div class="border-b-2 border-[#410063] pb-6 mb-8 text-center">
                                <h4 class="font-title-lg text-title-lg font-bold text-primary uppercase tracking-widest">
                                    Universitas Amikom</h4>
                                <p class="font-body-sm text-body-sm text-gray-400 mt-1">Fakultas Ilmu Komputer</p>
                            </div>
                            <h5 class="font-label-lg text-label-lg text-center mb-8 underline">SURAT KETERANGAN AKTIF KULIAH
                            </h5>
                            <div class="space-y-4 font-body-sm text-body-sm text-gray-900">
                                ...
                                <p class="pt-4">Adalah benar mahasiswa yang bersangkutan aktif mengikuti perkuliahan pada
                                    semester Ganjil Tahun Akademik 2023/2024.</p>
                                <p class="">Surat keterangan ini dibuat untuk keperluan: <strong>Pengajuan Beasiswa
                                        Prestasi</strong>.</p>
            ...
            <div class="xl:col-span-4 flex flex-col gap-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-6">
                    <div class="pb-4 border-b border-gray-100">
                        ...
                        <div class="space-y-1">
                            <p class="text-label-sm text-gray-500 uppercase tracking-wider font-semibold">Tujuan Dokumen
                            </p>
                            <p class="text-body-md font-medium text-gray-900">Pengajuan Beasiswa Prestasi Kemendikbud 2023
                            </p>
                        </div>
                    </div>
                    <div>
            ...
            <div class="space-y-4 mb-8">
                ...
                <div class="role-group border rounded-xl overflow-hidden transition-all border-gray-200"
                    ...
                    <label class="flex items-center gap-3 p-4 bg-gray-50 cursor-pointer">
                        <input checked class="role-checkbox w-5 h-5 rounded border-gray-300 text-error focus:ring-error"
                    ...
                    <div class="reason-fields p-4 bg-white border-t border-gray-100 space-y-3 hidden" id="fields-kaprodi">
                        <div>
                            <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Alasan
                                Penolakan</label>
                            <select
        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 border border-gray-200 font-title-lg">
            ...
            <div class="space-y-2 mb-8">
                <label
                    ...
                    <input class="approve-role-checkbox w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary"
