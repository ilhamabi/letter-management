                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead class="bg-[#F8F9FA] border-b border-gray-200">
                            <tr>
                                <th class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 tracking-wider">Nama
                                    Mahasiswa</th>
                                <th class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 tracking-wider">NIM</th>
                                <th class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 tracking-wider">Jenis
                                    Surat</th>
                                <th class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 tracking-wider">Tanggal
                                    Pengajuan</th>
                                <th class="px-6 py-4 text-xs font-semibold uppercase text-gray-500 tracking-wider">Peran
                                </th>
                                <th
            ...
            @else
                ...
                <div class="flex flex-col items-center justify-center py-20 px-6 text-center">
                    ...
                    <p class="text-gray-600 text-sm max-w-md">
                        Semua dokumen telah diproses. Anda akan melihat pengajuan baru di sini saat mahasiswa melakukan
                        pengajuan.
                    </p>
                </div>
            @endif
