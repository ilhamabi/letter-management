...
<div class="space-y-8">
    ...
    <div class="mb-4">
        <nav class="flex items-center gap-2 text-gray-400 mb-3">
            <a class="font-body-sm text-body-sm hover:text-primary transition-colors" href="{{ route('lecturer.submissions.index') }}">Persetujuan Dokumen</a>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div class="xl:col-span-4 flex flex-col gap-6">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <h3 class="font-title-lg text-title-lg text-gray-900 mb-6 flex items-center gap-2 pb-3 border-b border-gray-200">
                    <x-icon name="badge" class="w-5 h-5 text-primary" />Peran Dosen
                </h3>
                <div class="">
            ...
            <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-6">
                <div class="pb-4 border-b border-gray-100">
                    <h3 class="font-title-lg text-title-lg text-gray-900 mb-4 flex items-center gap-2"><x-icon name="info" class="w-5 h-5 text-primary" />Detail Pengajuan</h3>
                    <div class="space-y-1">
                ...
                <div>
                    <h3 class="font-title-lg text-title-lg text-gray-900 mb-6 flex items-center gap-2"><x-icon name="history" class="w-5 h-5 text-primary" />Riwayat Status</h3>
                    <div class="space-y-0">
...
<div class="fixed bottom-8 left-1/2 -translate-x-1/2 z-[100] opacity-0 pointer-events-none transform translate-y-4" id="success-toast">
    <div class="bg-gray-900 text-white px-6 py-4 rounded-xl shadow-2xl flex items-center gap-3">
        <x-icon name="check_circle" class="w-5 h-5 text-green-400" />
