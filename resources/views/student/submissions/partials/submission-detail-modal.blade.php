...
<x-modal id="status-modal" title="Detail Status Pengajuan" maxWidth="max-w-lg">
    ...
    <div id="modal-approved-doc-section" class="hidden space-y-3 p-4 bg-emerald-50 rounded-xl border border-emerald-200 my-4 animate-fade-in">
        ...
        <div class="flex gap-2.5 pt-1">
            ...
            <a id="btn-download-approved-doc" href="#" target="_blank" class="flex-1 py-2.5 px-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-xs">
