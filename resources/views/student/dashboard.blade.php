...
@section('content')
    ...
    <section
        ...
        <div>
            <h2 class="font-headline-md text-headline-md text-on-surface mb-2">Selamat datang kembali, {{ $studentName }}
            </h2>
    ...
    <section class="bg-pure-white rounded-xl border border-outline-variant shadow-sm overflow-hidden flex flex-col">
        <div class="p-6 border-b border-outline-variant flex justify-between items-center">
            ...
            <a href="{{ url('/student/submission-history') }}"
        ...
        @else
            <div class="flex flex-col items-center justify-center py-12 px-6 text-center">
                ...
                <h4 class="font-headline-sm text-headline-sm text-deep-black mb-2">Tidak ada pengajuan yang sedang
                    berlangsung</h4>
                <p class="font-body-md text-body-md text-on-surface-variant mb-6">Semua permintaan dokumen Anda telah
                    selesai diproses atau belum ada pengajuan baru.</p>
            ...
            <div class="p-6 space-y-6 overflow-y-auto max-h-[60vh]">
                ...
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <div class="space-y-1">
                        ...
                        <p class="font-label-lg text-label-lg text-deep-black font-bold" id="modal-purpose">Syarat Beasiswa
                        </p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-[10px] uppercase tracking-widest text-on-surface-variant font-semibold">Dosen Dituju
                        </p>
                        <p class="font-label-lg text-label-lg text-deep-black font-bold" id="modal-lecturer">Dr. Heri
                            Setyawan, M.Kom. (Dosen Wali)</p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-[10px] uppercase tracking-widest text-on-surface-variant font-semibold">NIM</p>
                        <p class="font-label-lg text-label-lg text-deep-black font-bold" id="modal-nim">{{ $nim }}
                        </p>
                    </div>
                    <div class="space-y-1">
                        <p class="text-[10px] uppercase tracking-widest text-on-surface-variant font-semibold">Program Studi
                        </p>
                ...
                <div class="bg-primary-fixed/30 p-4 rounded-lg border border-primary/10 flex gap-3">
                    ...
                    <p class="text-body-sm text-on-surface-variant">Proses verifikasi biasanya memakan waktu 1-2 hari kerja.
                        Jika belum ada pembaruan, Anda dapat mengirim pengingat.</p>
                </div>
            </div>
    ...
    <div class="fixed inset-0 z-[60] flex items-center justify-center hidden" id="cancel-confirm-modal">
        ...
        <div
            ...
            <div class="p-6">
                <p class="font-body-md text-body-md text-on-surface-variant">Apakah Anda yakin ingin membatalkan pengajuan
                    surat ini? Tindakan ini tidak dapat dibatalkan.</p>
            </div>
            <div class="p-6 bg-surface-gray border-t border-outline-variant flex justify-end gap-3">
                <button
                    class="px-6 py-2 border border-error text-error font-label-md rounded-lg hover:bg-error-container transition-colors"
