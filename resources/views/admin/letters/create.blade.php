...
@section('title', 'Buat Template Surat Baru - Layanan Dokumen')

@section('content')
    <!-- Page Navigation Header -->
    <div class="flex items-center justify-between pb-4 border-b border-gray-200 mb-6">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.letters.index') }}" class="p-2 rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors" title="Kembali ke Daftar Surat">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1 font-body-sm">Konfigurasi informasi dasar dan alur persetujuan baru.</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto space-y-8">
        <form class="space-y-8" onsubmit="event.preventDefault();">
            ...
            <x-admin.letter-editor-actions deleteModalId="delete-confirmation-modal" backRoute="admin.letters.index" />
        </form>
    </div>
