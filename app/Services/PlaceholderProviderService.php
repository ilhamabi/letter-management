            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'aliases' => ['{{Daftar Anggota (Teks)}}'],
                        'label' => 'Daftar Anggota (Teks)',
                        'description' => 'Daftar teks nama & NIM seluruh anggota kelompok',
                        'sample' => "1. Aditya Giri Kurniawan (23.01.4969)\n2. Ahmad Doni (23.01.4972)\n3. Hafizh Umar Fadillah (23.01.5005)",
                    ],
                ],
            ],
            [
                ...
                'items' => [
                    ...
                    [
                        'key' => '{{print_date}}',
                        'aliases' => ['{{Tanggal Cetak}}'],
                        'label' => 'Tanggal Cetak',
                        'description' => 'Tanggal dokumen dicetak / di-generate',
                        'sample' => '11 September 2025',
                    ],
                    [
                        'key' => '{{approval_date}}',
                        'aliases' => ['{{Tanggal Persetujuan}}'],
                        'label' => 'Tanggal Persetujuan',
                        'description' => 'Tanggal surat disetujui oleh pejabat berwenang',
                        'sample' => '11 September 2025',
                    ],
                ],
            ],
